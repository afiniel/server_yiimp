...
message_box "Afiniel Yiimp Setup Installer" \
"You have choosen to install YiiMP!
\n\nThis option will install all componets of Yiimp for your pool!.
...
--yesno "Are you using a domain name? Example: afiniel.tech?
...
DEFAULT_DomainName=afiniel.tech
input_box "Domain Name" \
"Enter your domain name. If using a subdomain enter the full domain as in pool.afiniel.tech
\n\nDo not add www. to the domain name or the installation may be corrupted.
...
\n\nGo to whatsmyip.org if you are unsure this is your public IP, if you put wrong public IP you cant access site/AdminPortal.
\n\nYour Public IP:" \
${DEFAULT_PublicIP} \
PublicIP
...
--yesno "Please verify your answers are correct before continue the setup:
...
YiiMPRepo='https://github.com/afiniel/yiimp.git'
